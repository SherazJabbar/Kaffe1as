  ...
  <div>
    <div class="desktopMenu">
      <v-toolbar flat>
        ...
        <div><v-img contain src="../assets/images/kaffe-logo.svg"> </v-img></div>
        <v-spacer></v-spacer>
        <v-toolbar-items class="hidden-sm-and-down">
          <v-btn text><router-link to="/" tag="li">Maskiner </router-link> </v-btn>
          <v-btn text><router-link to="/" tag="li">Kaffebønner </router-link> </v-btn>
          <v-btn text><router-link to="/" tag="li">Te </router-link> </v-btn>
          <v-btn text><router-link to="/" tag="li">Tilbehør </router-link> </v-btn>
          <v-btn text>
            <router-link to="/" tag="li">Sjokolade </router-link>
          </v-btn>
          <!-- <v-avatar color="grey lighten-1" class="mt-2">
        ...
        <v-toolbar-items class="hidden-sm-and-down">
          <v-btn text
            ><router-link to="/" tag="li"><v-icon>mdi-magnify</v-icon> </router-link>
          </v-btn>
          <v-btn text
          ...
          <v-btn text
            ><router-link to="/" tag="li"><v-icon>mdi-cart-outline</v-icon> </router-link>
          </v-btn>
    ...
    <div class="mobileMenu">
      <v-app-bar flat>
        ...
        <v-btn icon
          ><router-link to="/" tag="li"><v-icon>mdi-heart-outline</v-icon> </router-link>
        </v-btn>
          ...
          <v-list-item-group v-model="group" class="text-center">
            ...
            <div class="mt-10">
              <v-list-item>
                <v-list-item-title>
                  <v-btn text
                    ><router-link to="/" tag="li">Maskiner </router-link>
              ...
              <v-list-item>
                <v-list-item-title>
                  <v-btn text
                    ><router-link to="/" tag="li">Kaffebønner </router-link>
                  </v-btn></v-list-item-title
                >
              </v-list-item>
              ...
              <v-list-item>
                <v-list-item-title
                  ><v-btn text
                    ><router-link to="/" tag="li">Te </router-link>
                  </v-btn></v-list-item-title
                >
              </v-list-item>
              ...
              <v-list-item>
                <v-list-item-title>
                  <v-btn text
                    ><router-link to="/" tag="li">Tilbehør </router-link>
                  </v-btn></v-list-item-title
                >
              </v-list-item>
